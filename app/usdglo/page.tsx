  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50">
        <div
          className="px-6 py-4"
          style={{ background: "linear-gradient(135deg, #163239, #81D7B4)" }}
        >
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm mb-6" style={{ border: "1px solid #81D7B4" }}>
          <div
            ...
            style={{
              borderColor: "#81D7B4",
              background: "linear-gradient(135deg, #81D7B4/5, #81D7B4/10)",
            }}
          >
            <h2 className="text-lg font-medium" style={{ color: "#81D7B4" }}>
          ...
          <div className="px-6 py-4">
            <div className="space-y-3">
              ...
              <div className="text-sm text-gray-600">
                ...
                <br />
                <strong>Allow:</strong> GET, HEAD, OPTIONS
                <br />
        ...
        <div className="bg-white rounded-lg shadow-sm" style={{ border: "1px solid #81D7B4" }}>
          ...
          {showFilters && (
            <div
              ...
              style={{
                borderColor: "#81D7B4",
                background: "linear-gradient(135deg, #81D7B4/10, #81D7B4/5)",
              }}
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium mb-2" style={{ color: "#81D7B4" }}>
                    Filter by Type
                  </label>
                  <select
                    value={filterType}
          ...
          <div className="px-6 py-4">
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-2xl font-bold text-gray-900">
                      $
                      {data?.results
                        ?.filter((tx) => (tx.transaction_type || tx.type) !== "withdrawal")
            ...
            {data?.results && data.results.length > 0 && (
              <div className="mb-6">
                <h3 className="text-lg font-medium mb-4" style={{ color: "#81D7B4" }}>
                  Transaction Results
                </h3>
                  ...
                  <table className="min-w-full divide-y" style={{ borderColor: "#81D7B4" }}>
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {data.results
                        ...
                        .filter(
                          () => !filterStatus || "completed".includes(filterStatus.toLowerCase()),
                        )
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              {transaction.txnhash ? (
                                <button
                                  onClick={() =>
                                    window.open(
                                      `https://celoscan.io/tx/${transaction.txnhash}`,
                                      "_blank",
                                    )
                                  }
                ...
                onClick={() => {
                  ...
                  if (jsonElement) {
                    jsonElement.style.display =
                      jsonElement.style.display === "none" ? "block" : "none";
                  }
                }}
