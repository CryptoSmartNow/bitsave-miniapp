...
export default function Hero() {
  ...
  const shimmerElementsRef = useRef<
  ...
  useEffect(() => {
    ...
    if (!shimmerElementsRef.current.length) {
      shimmerElementsRef.current = Array(10)
        .fill(0)
        .map(() => ({
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="space-y-6">
              <div className="relative">
                ...
                <div className="absolute -top-8 -left-4 w-16 h-16 opacity-20">
                  <svg
                    viewBox="0 0 64 64"
                    className="w-full h-full text-[#81D7B4] animate-spin"
                    style={{ animationDuration: "20s" }}
                  >
                    <polygon
                      points="32,8 40,24 56,24 44,36 48,52 32,44 16,52 20,36 8,24 24,24"
                      fill="currentColor"
                    />
                  </svg>
                </div>
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight relative z-10">
                  <span className="relative inline-block bg-gradient-to-r from-[#81D7B4] via-blue-500 to-[#81D7B4] bg-clip-text text-transparent">
                    ...
                    <div
                      className="absolute -top-2 left-1/4 w-3 h-3 bg-blue-500 rounded-full animate-pulse"
                      style={{ animationDelay: "0.5s" }}
                    ></div>
                    <div
                      className="absolute -top-1 right-1/4 w-2 h-2 bg-[#81D7B4] rounded-full animate-pulse"
                  ...
                  <span className="block text-[#81D7B4] relative">
                    ...
                    {/* Web3 symbols */}
                    <div
                      className="absolute -right-8 top-2 text-2xl opacity-30 animate-bounce"
                      style={{ animationDelay: "2s" }}
                    >
                      ⛓️
                    </div>
                    <div
                      className="absolute -left-6 -top-2 text-xl opacity-40 animate-pulse"
                      style={{ animationDelay: "1s" }}
                    >
                      🔗
                    </div>
              ...
              <p className="text-lg md:text-xl text-gray-600 leading-relaxed max-w-lg">
                Bitsave Protocol helps you save and earn in Crypto without losing your savings to
          ...
          <div className="relative">
            ...
            <div className="relative bg-gradient-to-br from-white via-gray-50 to-white rounded-3xl p-8 shadow-2xl border border-gray-200/50 overflow-hidden">
              ...
              <div className="relative z-10 bg-gray-50/50 rounded-xl p-4 mb-4 border border-gray-200/30">
                ...
                <div className="w-full bg-gray-200 rounded-full h-2 mb-2">
                  <div
                    className="bg-gradient-to-r from-[#81D7B4] to-blue-500 h-2 rounded-full"
                    style={{ width: "75%", animation: "fillProgress 2s ease-out" }}
                  ></div>
                </div>
              ...
              <div className="relative z-10 space-y-2">
                ...
                {[
                  ...
                  <div
                    key={i}
                    className="flex items-center justify-between py-2 px-3 bg-white/50 rounded-lg border border-gray-200/30"
                  >
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 bg-[#81D7B4] rounded-full animate-pulse"></div>
                    ...
                    <div className="text-right">
                      <div className={`${activity.color} text-xs font-medium`}>
                        {activity.amount}
                      </div>
            ...
            <div
              className="absolute -bottom-4 -left-4 bg-gradient-to-br from-[#81D7B4] to-green-500 rounded-xl p-3 shadow-lg border border-[#81D7B4]/30"
