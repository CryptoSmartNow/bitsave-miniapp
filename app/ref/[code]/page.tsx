...
export default function ReferralPage() {
  ...
  return (
    <div
      className={`min-h-screen bg-gradient-to-br from-gray-50 to-white ${spaceGrotesk.className}`}
    >
      <div className="container mx-auto px-4 py-16">
        ...
        >
          ...
          {referralCode && (
            ...
            >
              <p className="text-sm text-gray-600">
                🎉 You&apos;re joining through a referral! Both you and your friend will earn
          ...
          <motion.div
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(255,255,255,0.9) 0%, rgba(255,255,255,0.8) 50%, rgba(129,215,180,0.1) 100%)",
          ...
          >
            ...
            <div className="relative z-10">
              <h3 className="text-2xl font-bold bg-gradient-to-r from-gray-900 to-[#81D7B4] bg-clip-text text-transparent mb-8 text-center">
                Join Our Community
              </h3>
