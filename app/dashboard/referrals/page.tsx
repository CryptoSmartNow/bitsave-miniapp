...
export default function ReferralsPage() {
  ...
  const { referralData, loading, error, generateReferralCode, refreshReferralData } =
    useReferrals();
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
              Share BitSave with friends and earn rewards together! Build your network and grow your
              savings.
            </p>
          </motion.div>
            ...
            >
              <div className="relative z-10">
                ...
                <p className="text-lg text-gray-600 mb-8 max-w-md mx-auto leading-relaxed">
                  Create your unique referral link to start earning{" "}
                  <span className="font-semibold text-[#81D7B4]">5 points</span> when friends create
                  their first savings plan.
                </p>
                <motion.button
              ...
              >
                ...
                <div className="flex items-start space-x-3 p-4 bg-gradient-to-r from-emerald-50 to-cyan-50 rounded-xl border border-emerald-200/50">
                  ...
                  <p className="text-sm text-emerald-700 leading-relaxed">
                    ...
                    <span className="font-semibold">5 points</span> when they create their first
                    savings plan. The more friends you refer, the more you earn!
                  </p>
                </div>
              </motion.div>
                  ...
                  <div className="text-center md:text-left">
                    ...
                    <div className="w-full bg-white/20 rounded-full h-3">
                      <motion.div
                        initial={{ width: 0 }}
                        animate={{
                          width: `${Math.min(100, ((referralData.stats.totalRewards || 0) / 100) * 100)}%`,
                        }}
                    ...
                    <p className="text-xs opacity-75 mt-2">
                      {Math.min(100, ((referralData.stats.totalRewards || 0) / 100) * 100).toFixed(
                        0,
                      )}
                      % to next level
                    </p>
