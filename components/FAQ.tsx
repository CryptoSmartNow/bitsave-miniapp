        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          {allCards.map((card) => (
            <div key={card.id} className="group relative">
              <div
                className={`relative p-8 rounded-2xl ${card.color} shadow-lg backdrop-blur-xl border border-[#81D7B4]/20 transition-all duration-500 ${card.hoverColor} group-hover:shadow-xl h-full`}
              >
                {/* Background Effects */}
                ...
                <div className="relative z-10 h-full flex flex-col">
                  ...
                  {/* Answer */}
                  <p className="text-gray-600 leading-relaxed mb-6">{card.answer}</p>
