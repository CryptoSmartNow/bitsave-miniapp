  ...
  return (
    <footer className="relative overflow-hidden bg-[#f8fafa] border-t border-[#81D7B4]/10">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-12 lg:px-8">
        <div className="rounded-3xl bg-gradient-to-b from-white/80 to-white/40 backdrop-blur-xl border border-[#81D7B4]/20 p-8 lg:p-12 animate-fade-in-up">
        ...
        <div className="mt-12 pt-8 border-t border-[#81D7B4]/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-4 text-xs text-gray-500">
              <a href="#privacy" className="hover:text-[#81D7B4] transition-colors duration-300">
                Privacy Policy
              </a>
              <span className="select-none">·</span>
              <a href="#terms" className="hover:text-[#81D7B4] transition-colors duration-300">
                Terms of Service
              </a>
              <span className="select-none">·</span>
              <a href="#cookies" className="hover:text-[#81D7B4] transition-colors duration-300">
                Cookie Policy
              </a>
            </div>
          </div>
